...
module.exports = {
    ...
    run: async(client, message, args) => {
        if (!message.member.roles.cache.has('862058803344048148')) return message.reply('This command is only allowed to `Contributors` for now, it may soon be available to everyone after being tested', { allowedMentions: { repliedUser: false } });
