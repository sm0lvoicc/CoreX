...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        .addFields( 
            ...
            {
                name: credit5.tag,
                value: "Amazing Developer, She has helped Polish CoreX and find many bugs in it, join her [Server](https://discord.gg/single)"
            },
            {
                name: credit6.tag,
                value: "Graphic Designer who has helped change CoreX's logo and overall design, join his [Server](https://discord.gg/EgT7tTR6kx)"
            }
        )
