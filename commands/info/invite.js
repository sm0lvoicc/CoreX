...
module.exports = {
  ...
  run: async (client, message, args) => {
    let tosEmbed = new Discord.MessageEmbed()
      ...
      .setDescription(
        "By using this bot in your server, you agree to our ToS stated below.",
      )
      .addField(
        "**1.** Raiding",
        "This bot will not be part of any raiding or nuking in any server.",
      )
      .addField(
        "**2.** Discord ToS",
        "You must not be abusing any rules of the [Discord ToS.](https://discord.com/terms)",
      )
      .addField(
      ...
      sMessage
        ...
        .then(async (collected) => {
          ...
          if (reaction.emoji.name === "✅") {
            let userReactions = sMessage.reactions.cache.filter((reaction) =>
